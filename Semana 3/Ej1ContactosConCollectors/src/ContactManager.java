...
public class ContactManager {
  ...
  public List<Contact> findByNamePrefix(String prefix) {
    ...
    return contacts.stream()
        .filter(contact -> contact.getName().toLowerCase().startsWith(prefix.toLowerCase()))
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Ana: " + mgr.addContact(new Contact("Ana Garcia", "ana@mail.com", "555-1111")));
    System.out.println(
        "Luis: " + mgr.addContact(new Contact("Luis Lopez", "luis@mail.com", "555-2222")));
    System.out.println(
        "Maria: " + mgr.addContact(new Contact("Maria Torres", "maria@mail.com", "555-3333")));
    System.out.println(
        "Ana duplicada: " + mgr.addContact(new Contact("Ana Garcia", "ana@mail.com", "555-9999")));
    System.out.println(
    ...
    mgr.findByEmail("maria@mail.com")
        .ifPresentOrElse(
            c -> System.out.println("Encontrado: " + c), () -> System.out.println("No encontrado"));
